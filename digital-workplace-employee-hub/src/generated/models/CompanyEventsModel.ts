...
export interface OrganizerAccountValue {
  "@odata.type": string;
  Claims: string;
  DisplayName: string;
  Email: string;
...
export interface CompanyEventsBase {
  ID?: number;
  Title: string;
  EventName: string;
  Date: string;
  ...
  Location?: string;
  "OrganizerAccount#Claims"?: string;
  Image?: string;
  Modified?: string;
  Created?: string;
...
export interface CompanyEventsRead extends CompanyEventsBase {
  Status: StatusValue;
  OrganizerAccount?: OrganizerAccountValue;
  Author?: AuthorValue;
  Editor?: EditorValue;
}

export interface CompanyEventsWrite extends CompanyEventsBase {
  Status: string;
  OrganizerAccount?: OrganizerAccountValue;
  Author?: AuthorValue;
  Editor?: EditorValue;
