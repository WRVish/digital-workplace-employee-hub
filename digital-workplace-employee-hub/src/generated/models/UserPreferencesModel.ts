...
export interface UserPreferencesRead extends UserPreferencesBase {
  Theme?: ThemeValue;
...
export interface UserPreferencesWrite extends UserPreferencesBase {
  Theme?: string;
  ColorScheme?: string;
  Author?: AuthorValue;
  Editor?: EditorValue;
