...
export interface LeaveTypeValue {
  "@odata.type": string;
  Value: string;
  Id: number;
}
...
export interface ApproverAccountValue {
  "@odata.type": string;
  Claims: string;
  DisplayName: string;
  Email: string;
...
export interface LeaveRequestsBase {
  ID?: number;
  Title: string;
  LeaveID: string;
  "LeaveType#Id"?: number;
...
export interface LeaveRequestsRead extends LeaveRequestsBase {
  LeaveType: LeaveTypeValue;
  ApprovalStatus: ApprovalStatusValue;
  Employee?: EmployeeValue;
  ApproverAccount?: ApproverAccountValue;
  Author?: AuthorValue;
  Editor?: EditorValue;
}

export interface LeaveRequestsWrite extends LeaveRequestsBase {
  LeaveType: string;
