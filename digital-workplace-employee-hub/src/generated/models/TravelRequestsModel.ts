...
export interface TravelRequestsBase {
  ID?: number;
  Title: string;
  TravelID: string;
  Destination: string;
...
export interface TravelRequestsRead extends TravelRequestsBase {
...
export interface TravelRequestsWrite extends TravelRequestsBase {
